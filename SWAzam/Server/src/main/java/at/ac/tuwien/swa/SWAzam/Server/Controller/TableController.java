...
public class TableController {
	...
	private void fillWithTestData() {
		...
		recognitionRequests.add(new RecognitionRequest(1, new Date(System.currentTimeMillis()), 
					new Song("Volbeat", "Still Counting", "Guitar Gangsters & Cadillac Blood", 2008), "peer url", true));
		
		recognitionRequests.add(new RecognitionRequest(2, new Date(System.currentTimeMillis()), 
					new Song("Volbeat", "Cape of our Hero", "Outlaw Gentleman and Shady Ladies", 2012), "peer url", true));
		
		recognitionRequests.add(new RecognitionRequest(3, new Date(System.currentTimeMillis()), 
				new Song("", "", "", 0), "peer url", false));
		
		recognitionRequests.add(new RecognitionRequest(2, new Date(System.currentTimeMillis()), 
				new Song("Rise Against", "Saviour", "Appeal to Reason", 2008), "peer url", true));
